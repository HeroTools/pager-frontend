...
export const Toolbar = () => {
  ...
  return (
    <div className="flex items-center justify-between h-10 p-2 border-b bg-main-sidebar">
      <div className="flex-1" />
      <div className="min-w-72 max-w-[640px] flex-1">
        <SearchDialogContent workspaceId={workspaceId} />
        <Button
          size="sm"
          className="border-b border-border hover:bg-content-area w-full justify-start h-7 px-2 bg-main-sidebar"
          onClick={() => {
