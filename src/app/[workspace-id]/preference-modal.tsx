          ...
          <div className="px-4 pb-4 flex flex-col gap-y-2">
            <Dialog open={editOpen} onOpenChange={setEditOpen}>
              <DialogTrigger asChild>
                <div className="px-5 py-4 bg-white rounded-lg border border-border-subtle cursor-pointer hover:bg-gray-50">
            ...
            <Button
              ...
              className="flex items-center justify-start gap-x-2 py-4 bg-white rounded-lg border border-border-subtle cursor-pointer hover:bg-gray-50 text-rose-600"
            >
