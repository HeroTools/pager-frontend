...
export const useConversationCreateStore = create<ConversationCreateStoreState>()(
  devtools(
    (set, get) => ({
      ...
      clearSelection: () => {
        set({ selectedMembers: [], searchQuery: '' }, false, 'clearSelection');
      },
      ...
      getConversationTitle: () => {
        ...
        } and ${selectedMembers.length - 1} other${selectedMembers.length > 2 ? 's' : ''}`;
      },
